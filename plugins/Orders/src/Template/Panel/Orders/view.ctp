...
<strong><?php echo h(__d('webshop_orders', 'Amount')); ?>:</strong> <?php echo h($this->Number->currency($order->amount, 'EUR')); ?><br>
<strong><?php echo h(__d('webshop_orders', 'Remaining')); ?>:</strong> <?php echo h($this->Number->currency($order->remaining, 'EUR')); ?><br>
<strong><?php echo h(__d('webshop_orders', 'Status')); ?>:</strong> <?php echo h($this->Orders->statusText($order->status)); ?><br>
